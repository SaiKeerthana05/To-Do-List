...
import com.example.android.to_do_list.EditorActivity;
...
public class TaskActivity extends AppCompatActivity implements
    ...
    private void insertTask() {
        ...
        // and the task Newspaper's attributes are the values.
        ContentValues values = new ContentValues();
        values.put(TaskEntry.COLUMN_TASK_NAME, "Newspaper");
        values.put(TaskEntry.COLUMN_TASK_DESCRIPTION, "Read today's newspaper");

        // Insert a new row for Newspapaer task into the provider using the ContentResolver.
        // Use the {@link TaskEntry#CONTENT_URI} to indicate that we want to insert
        // into the tasks database table.
        // Receive the new content URI that will allow us to access the task Newspaper's data in the future.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            // Respond to a click onthe "Delete all entries" menu option
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        // Update {@link TaskCursorAdapter} with this new cursor containing updated pet data
