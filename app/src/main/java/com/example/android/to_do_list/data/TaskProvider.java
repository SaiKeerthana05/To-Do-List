...
/**
 * {@link ContentProvider} for To-Do-List app.
 */
public class TaskProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.to_do_list/tasks" will map to the
        ...
        // For example, "content://com.example.android.to_do_list/tasks/3" matches, but
        // "content://com.example.android.to_do_list/tasks" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case TASK_ID:
                ...
                // For an example URI such as "content://com.example.android.to_do_list/tasks/3",
